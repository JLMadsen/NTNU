...
# split batches
x_train_batches = torch.split(x_train.cuda(), BATCHES) if USE_CUDA else torch.split(x_train, BATCHES)
y_train_batches = torch.split(y_train.cuda(), BATCHES) if USE_CUDA else torch.split(y_train, BATCHES)
